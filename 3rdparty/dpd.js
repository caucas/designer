...
dpd.dimension = dpd("/dimension");
dpd.dimension.on = function(ev, fn) {
  return dpd.on("dimension" + ":" + ev, fn);
}
dpd.dimension.once = function(ev, fn) {
  return dpd.once("dimension" + ":" + ev, fn);
}
dpd.dimension.off = function(ev, fn) {
  return dpd.off("dimension" + ":" + ev, fn);
}
dpd.dimension.rename = function (path, body, fn) {
  dpd.dimension.exec("rename", path, body, fn);
}
...
dpd.resolution = dpd("/resolution");
dpd.resolution.on = function(ev, fn) {
  return dpd.on("resolution" + ":" + ev, fn);
}
dpd.resolution.once = function(ev, fn) {
  return dpd.once("resolution" + ":" + ev, fn);
}
dpd.resolution.off = function(ev, fn) {
  return dpd.off("resolution" + ":" + ev, fn);
}
dpd.resolution.rename = function (path, body, fn) {
  dpd.resolution.exec("rename", path, body, fn);
}
...
dpd.debithistory = dpd("/debit-history");
dpd.debithistory.on = function(ev, fn) {
  return dpd.on("debit-history" + ":" + ev, fn);
}
dpd.debithistory.once = function(ev, fn) {
  return dpd.once("debit-history" + ":" + ev, fn);
}
dpd.debithistory.off = function(ev, fn) {
  return dpd.off("debit-history" + ":" + ev, fn);
}
dpd.debithistory.rename = function (path, body, fn) {
  dpd.debithistory.exec("rename", path, body, fn);
}
...
dpd.karaoke = dpd("/karaoke");
dpd.karaoke.on = function(ev, fn) {
  return dpd.on("karaoke" + ":" + ev, fn);
}
dpd.karaoke.once = function(ev, fn) {
  return dpd.once("karaoke" + ":" + ev, fn);
}
dpd.karaoke.off = function(ev, fn) {
  return dpd.off("karaoke" + ":" + ev, fn);
}
dpd.karaoke.rename = function (path, body, fn) {
  dpd.karaoke.exec("rename", path, body, fn);
}
...
dpd.currency = dpd("/currency");
dpd.currency.on = function(ev, fn) {
  return dpd.on("currency" + ":" + ev, fn);
}
dpd.currency.once = function(ev, fn) {
  return dpd.once("currency" + ":" + ev, fn);
}
dpd.currency.off = function(ev, fn) {
  return dpd.off("currency" + ":" + ev, fn);
}
dpd.currency.rename = function (path, body, fn) {
  dpd.currency.exec("rename", path, body, fn);
}
...
dpd.credithistory = dpd("/credit-history");
dpd.credithistory.on = function(ev, fn) {
  return dpd.on("credit-history" + ":" + ev, fn);
}
dpd.credithistory.once = function(ev, fn) {
  return dpd.once("credit-history" + ":" + ev, fn);
}
dpd.credithistory.off = function(ev, fn) {
  return dpd.off("credit-history" + ":" + ev, fn);
}
dpd.credithistory.rename = function (path, body, fn) {
  dpd.credithistory.exec("rename", path, body, fn);
}
